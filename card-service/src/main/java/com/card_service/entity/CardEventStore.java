...
@Entity
@Table(name = "card_event_store", indexes = {
...
public class CardEventStore {
    ...
    private String aggregateId; // Card reference
    
    @Column(name = "aggregate_type", nullable = false, length = 50)
    private String aggregateType; // "CARD"
    
    @Column(name = "event_type", nullable = false, length = 100)
    private String eventType; // "CardIssued", "CardActivated", etc.
