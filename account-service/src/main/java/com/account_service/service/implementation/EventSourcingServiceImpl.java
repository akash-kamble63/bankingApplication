...
public class EventSourcingServiceImpl implements EventSourcingService {
     ...
     * Must run in existing transaction (MANDATORY)
     */
    ...
    public void storeEvent(String aggregateId, String eventType, Object eventData, 
        ...
        try {
            ...
            // Store event
            AccountEventStore event = AccountEventStore.builder()
    ...
    public List<AccountEventStore> getEventsByDateRange(String accountNumber, 
        ...
        return eventStoreRepository.findByAggregateIdAndTimestampBetweenOrderByVersionAsc(
    ...
    public <T> T rebuildAggregate(String accountNumber, Class<T> aggregateClass) {
        try {
            ...
            log.info("Rebuilt aggregate: accountNumber={}, totalEvents={}", 
                accountNumber, events.size());
            return aggregate;
    ...
    public <T> T getSnapshotAtTime(String accountNumber, LocalDateTime pointInTime, 
        ...
        try {
            List<AccountEventStore> events = eventStoreRepository
                .findByAggregateIdAndTimestampBetweenOrderByVersionAsc(
